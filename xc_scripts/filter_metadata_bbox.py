...
Usage:
    ...
    python xc_scripts/filter_metadata_bbox.py --metadata "/Volumes/Z Slim/zslim_birdcluster/embeddings/emberiza_citrinella/metadata.csv" \
        --config "xc_configs_perch/config_emberiza_citrinella.yaml" \
        --clips-dir "/Volumes/Z Slim/zslim_birdcluster/clips/emberiza_citrinella"
